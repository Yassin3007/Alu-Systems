                ...
                @endif
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" name="name_ar" value="{{$project->getTranslation('name', 'ar')}}" class="form-control" id="field1">
                    </div>
                    <div class="col-md-6">
                      <label for="field2"> اسم المشروع باللغة الانجليزية</label>
                      <input type="text" name="name_en" value="{{$project->getTranslation('name', 'en')}}" class="form-control" id="field2">
                    </div>
                      ...
                      <div class="card-body pad">
                        <div class="mb-3">
                          <textarea class="textarea" name="data_ar" placeholder="Place some text here"
                                    ...
                                    {{ old('data_ar', $project->getTranslation('data', 'ar')) }}
                          </textarea>
                        </div>
                      ...
                      <div class="card-body pad">
                        <div class="mb-3">
                          <textarea class="textarea" name="data_en" placeholder="Place some text here"
                            ...
                            {{ old('data_en', $project->getTranslation('data', 'en')) }}
                          </textarea>
                        </div>
