                ...
                @endif
                      ...
                      <div class="card-body pad">
                        <div class="mb-3">
                          <textarea class="textarea" name="data_ar" placeholder="Place some text here"
                                    style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$partner->getTranslation('data', 'ar')}}</textarea>
                        </div>
                     ...
                     <div class="card-body pad">
                        <div class="mb-3">
                          <textarea class="textarea" name="data_en" placeholder="Place some text here"
                                    style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$partner->getTranslation('data', 'en')}}</textarea>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <img width="200px" src="{{$partner->getFirstMediaUrl('avatar')}}">
                    </div>
