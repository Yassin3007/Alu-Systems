                ...
                @endif
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" name="facilities_ar" value="{{old('facilities_ar')}}" class="form-control" id="field1">
                    </div>
                    <div class="col-md-6">
                      <label for="field2"> المرافق باللغة الانجليزية</label>
                      <input type="text" name="facilities_en" value="{{old('facilities_en')}}" class="form-control" id="field2">
                    </div>
