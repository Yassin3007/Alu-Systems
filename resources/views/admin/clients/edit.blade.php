                ...
                @endif
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" name="name_ar" value="{{$client->getTranslation('name', 'ar')}}" class="form-control" id="field1">
                    </div>
                    <div class="col-md-6">
                      <label for="field2"> الاسم  باللغة الانجليزية</label>
                      <input type="text" name="name_en" value="{{$client->getTranslation('name', 'en')}}" class="form-control" id="field2">
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <label for="field1">المشروع المميز</label>
                      <select name="project_id" id="project_id" class="form-control">
                        @foreach($projects as $project)
                          <option value="{{ $project->id }}" @if((int)$project->id == (int)$client->project_id) selected @endif> {{ $project->name }} </option>
                        @endforeach
                      </select>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <img width="200px" src="{{$client->getFirstMediaUrl('avatar')}}">
                    </div>
